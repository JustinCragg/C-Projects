...
/****************************************************************************************************
****************************************************************************************************/
DTWander::DTWander(Creature* creature) {
...
/****************************************************************************************************
****************************************************************************************************/
void DTWander::init(Creature* creature) {
}

/****************************************************************************************************
****************************************************************************************************/
void DTWander::update(Creature* creature) {
    ...
    // If the creature has not reached the target within 5 game seconds get a new target
...
/****************************************************************************************************
****************************************************************************************************/
void DTWander::exit(Creature* creature) {

}

/****************************************************************************************************
****************************************************************************************************/
void DTWander::randGoal(Creature* creature) {
